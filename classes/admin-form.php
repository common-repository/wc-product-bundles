...
class wcpb_product_interface {
	...
	function __construct() {
		add_filter( 'product_type_selector', array( $this, 'wcpb_add_product_bundle_type' ));
		add_filter( 'woocommerce_product_data_tabs', array( $this, 'wcpb_add_product_bundle_tab' ) );
		add_action( 'woocommerce_product_options_general_product_data', array( $this, 'wcpb_add_bundle_pricing_fields' ));
		add_action( 'woocommerce_product_data_panels', array( $this, 'wcpb_add_product_bundle_tab_panel' ));		
	}
